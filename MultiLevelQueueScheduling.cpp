...
#include<stdio.h>
//array size of 40 each  and asks user to enter 
//arrival time and burst time for different processes.
...
//here j,k,l be the three queues in which the processes based on their priority been divided.
